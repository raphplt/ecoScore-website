      ...
      <div className="mt-5">
        ...
        <div className="w-11/12 sm:w-3/4 mx-auto">
          <div className=" mx-auto ">
            <h2 className=" mt-16 text-xl text-secondary-color font-semibold">
              Produits tendances
            </h2>
            <div className="mb-12">
              <div className="flex items-start gap-5 mt-4 overflow-scroll overflow-y-hidden pb-4">
                {data &&
                  data
          ...
          <div className=" mx-auto">
            ...
            <div className="flex items-start gap-5 mt-4 overflow-y-hidden overflow-clip pb-4">
              {data &&
                data
                  .slice(0, lengthResultats)
                  .map((result) => (
          ...
          <div className=" mx-auto">
            ...
            <div className="flex items-start overflow-scroll gap-5 mt-4 overflow-y-hidden pb-4">
              {data &&
                data
                  .slice(0, lengthResultats)
                  .map((result) => (
